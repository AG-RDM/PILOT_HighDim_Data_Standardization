...
|---|---|---|---|
| Identification of challenges & use cases | Dec 2025 | PILOT-RDM participants | Two initial use cases defined |
| Technical follow-up meeting | Jan 2026 | INF + domain scientists | Agreement on next steps |
| Selection of initial test datasets | Jan–Feb 2026 | Domain experts + INF | Limited, well-understood datasets selected |
